...
Paylaşılan ChatGPT incelemesini okuduktan sonra veri geçmişini denetledim. Wikipedia
dosyası büyüyünce programın karıştırdığı metinler de değişiyor; aynı rastgelelik ayarı
bunu engellemiyor. Önceki koşular, uydurma bilgiler gösterilmeden önce bile farklılaşıyor.

Bu, bütün eski sonuçların yanlış olduğu anlamına gelmiyor. Ancak “sıradan karıştırma
yeter” önerisini geri çekiyoruz. Ayrıca yanlış cevap vermek, bilginin tamamen silinmesi
...
- [Açıklamalı güncel durum](docs/DURUM_2026-09-08_TR.md)
- [İngilizce kanıt raporu](docs/PROVENANCE_AUDIT_2026-09-08.md)
- [Eski rapor: tarihsel arşiv, güncel sonuç değildir](docs/archive/RAPOR_TR_2026-09-07.md)
